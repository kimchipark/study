...
create table user
(
	uno int auto_increment primary key comment '회원번호',
...
create table board
(
	bno int auto_increment primary key comment '게시물번호',
	uno int  comment '회원번호',
...
create table attach
(
	ano int auto_increment primary key comment '첨부번호',
...
create table reply
(
	reno int auto_increment primary key comment '댓글번호',
	bno int  comment '게시물번호',
	uno int  comment '회원번호',
	rnote text comment '댓글내용',
	rwdate datetime default now() comment '작성일',
	foreign key(bno) references board(bno),
	foreign key(uno) references user(uno)
);
