 ...
 * Generated at: 2022-09-07 07:29:31 UTC
...
bnote = bnote.replace("\n","<br>");
      ...
      out.write("\t{\r\n");
      out.write("\t\tif(confirm(\"해당 게시물을 삭제 하시겠습니까?\") == 1)\r\n");
      out.write("\t\t{\r\n");
      out.write("\t\t\tdocument.location = \"delete.jsp?kind=");
      out.print( kind );
      out.write("&key=");
      out.print( key );
      out.write("&page=");
      ...
      out.write("\t{\r\n");
      out.write("\t\tif(confirm(\"해당 댓글을 삭제 하시겠습니까?\") == 1)\r\n");
      out.write("\t\t{\r\n");
      out.write("\t\t\tdocument.location = \"deleterelply.jsp?kind=");
      out.print( kind );
      out.write("&key=");
      out.print( key );
      out.write("&page=");
      ...
      out.write("\t</tr>\r\n");
      out.write("</table>\r\n");
      out.write("<table border=\"\" style=\"width:100%;\">\r\n");
      out.write("\t<tr>\r\n");
      ...
      out.write("\t\t");
		...
		if(loginVO != null && uno.equals(loginVO.getNo()))
		{
			
      out.write("\r\n");
      out.write("\t\t\t&nbsp;|&nbsp;\r\n");
      out.write("\t\t\t<a href=\"modify.jsp?kind=");
      out.print( kind );
      out.write("&keytype=");
      out.print( keytype );
      out.write("&key=");
	...
	if(loginVO != null)
	{
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<form id=\"reply\" name=\"reply\" method=\"post\" action=\"replyok.jsp\"\r\n");
      out.write("\t\t\t\tonsubmit=\"return ReplyCheck();\">\r\n");
      ...
      out.print( key );
      out.write("\">\r\n");
      out.write("\t\t\t\t<input type=\"hidden\" id=\"keytype\" name=\"keytype\" value=\"");
      out.print( keytype );
      out.write("\">\r\n");
	...
	while(db.GetNext())
	{
      ...
      out.write("\t\t\t\t");
				...
				if( loginVO != null && runo.equals(loginVO.getNo()))
				{
