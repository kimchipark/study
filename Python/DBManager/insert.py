...
for i,con in enumerate(idx) :
    sql = ""
    sql += "insert into movie_info(mcode,title,making_year,release_year,score,genre,running_time, "
    sql += "age_list,poster,gen_m,gen_w,age_10,age_20,age_30,age_40,age_50,summary) "
